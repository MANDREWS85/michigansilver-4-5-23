  ...
  return(
    ...
    <div id="text-container" class="text-container">
      ...
      <div id="Container" class="Container">       
        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            ...
            description=""
            link="https://ebay.us/hsiwMv"
          />
        </div>

        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            src="https://i.ebayimg.com/images/g/rjIAAOSwNx1lwowu/s-l1600.jpg"
            title="2023 $5 Silver Canadian Maple Leaf 1 oz BU"
            description=""
            link="https://ebay.us/POiBTy"
          />
        </div>

        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            src="https://i.ebayimg.com/images/g/DqYAAOSw53JlzNv5/s-l1600.jpg"
            title="2024 UK 2 Pound Silver Britannia & Liberty .999 BU"
            description=""
            link="https://ebay.us/J38te8"
          />
        </div>
      ...
      <div id="Container" class="Container">       
        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            src="https://i.ebayimg.com/images/g/esAAAOSwsnNl-aw2/s-l1600.jpg"
            title="2024 $1 Australia Silver Kangaroo 1 oz .9999 Fine BU"
            description=""
            link="https://ebay.us/uVCccR"
          />
        </div>

        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            src="https://i.ebayimg.com/images/g/Wx8AAOSwLYJl1L9k/s-l1600.jpg"
            title="2024 $1 Australian Silver Kookaburra 1 oz .9999 Fine BU"
            description=""
            link="https://ebay.us/W5whKn"
          />
        </div>

        <div id="ChildContainer" class="ChildContainer">
          <BackgroundImage 
            src="https://i.ebayimg.com/images/g/6mkAAOSw91ZlwovA/s-l1600.jpg"
            title="1 Troy oz Silver US Navy Because of the Brave Round .999 Fine"
            description=""
            link="https://ebay.us/wNLkd5"
          />
        </div>
